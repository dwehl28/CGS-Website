  ...
  return (
    <main className="min-h-screen text-white">
      ...
      <section className="page-shell">
        <PageIntro
          eyebrow="Clubhouse uniform"
          title="CGS Merch"
          description="The merch side of CGS should feel wearable, clean, and properly tied to the identity of the club, not like an afterthought."
          actions={[
            {
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          {merchItems.map((item) => (
            <div
              key={item.name}
              className="panel rounded-[2rem] p-8 text-left"
            >
